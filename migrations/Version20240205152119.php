 ...
 */
final class Version20240205152119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649511FC912 ON user');
        $this->addSql('ALTER TABLE user DROP pdf_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD pdf_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649511FC912 FOREIGN KEY (pdf_id) REFERENCES pdf (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_8D93D649511FC912 ON user (pdf_id)');
    }
}
